	...
	const dummyContents = [
		{
			...
			category: 'Motivasi',
			image: 'https://plus.unsplash.com/premium_photo-1697474429687-5fbfdd7622d3?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
			icon: '🎬',
			type: 'Video',
			duration: '5 Min',
			bg: 'bg-slate-100',
		...
		},
		{
			...
			category: 'Amalan',
			image: 'https://media.istockphoto.com/id/2203759780/photo/close-up-of-hands-holding-prayer-beads-with-blurred-quran-background-performing-dhikr-in.webp?a=1&b=1&s=612x612&w=0&k=20&c=KbcWXErQhQzKEGAYbHaU8-HCacoOJMH7Owr09tTukjo=',
			icon: '',
			type: 'Artikel',
			duration: 'Baca',
			bg: 'bg-slate-100',
		...
		},
		{
			...
			category: 'Olahraga',
			image: 'https://plus.unsplash.com/premium_photo-1682088265889-8ab7586a0d18?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
			icon: '🧘',
			type: 'Video',
			duration: '15 Min',
			bg: 'bg-slate-100',
